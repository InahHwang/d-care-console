...
export function MarketingTargetCheckbox({
  ...
  return (
    <div className="border border-orange-200 rounded-lg bg-orange-50/50 overflow-hidden">
      {/* 헤더: 체크박스 + 토글 */}
      <div
        className="flex items-center justify-between px-4 py-3 cursor-pointer hover:bg-orange-100/50 transition-colors"
      ...
      {/* 확장 영역: 상세 입력 폼 */}
      {checked && isExpanded && (
        <div className="px-4 pb-4 pt-2 border-t border-orange-200 space-y-4">
          {/* 타겟 사유 */}
          <div>
