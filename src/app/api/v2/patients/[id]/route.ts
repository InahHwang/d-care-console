...
const patientPatchSchema = z.object({
  ...
  nextActionNote: z.string().nullish(),
  tags: z.array(z.string()).nullish(),
  eventDate: z.string().nullish(),
  isReservation: z.boolean().nullish(),
  changedBy: z.string().nullish(),
  age: z.union([z.string(), z.number()]).nullish(),
  region: z.union([z.string(), z.object({ province: z.string(), city: z.string().optional() })]).nullish(),
  closedReason: z.string().nullish(),
  isReactivation: z.boolean().nullish(),
  ...
  updateType: z.enum(['status', 'schedule']).nullish(),
  callbackReason: z.string().nullish(),
  callbackNote: z.string().nullish(),
  newScheduleDate: z.string().nullish(),
  recallEnabled: z.boolean().nullish(),
  recallBaseDate: z.string().nullish(),
}).passthrough();
